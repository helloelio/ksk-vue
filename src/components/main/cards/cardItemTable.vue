        ...
        <div class="card-buttons-menu-table" :class="{shownTable: active}">
          <button class="edit-button"
            ...
            <svg fill="none" width="12px" height="12px"
              ...
              <g clip-path="url(#a)" fill="#647A8C">
                <path class="first-part" d="m7.2933 1.8283-6.5379 6.5379-0.74102 3.0178c-0.041508
          ...
          <button class="delete-button" @click="$emit('delete-card', card.id)">
            <svg width="10px" height="12px" xmlns="http://www.w3.org/2000/svg">
              <path class="first-part" d="m8.943 3.3333h-7.8859c-0.23864
                  ...
                  0.22239 0.53085 0.49666v3.7968z"
                    fill="#647A8C"/>
              <path class="second-part" d="m8.6433
